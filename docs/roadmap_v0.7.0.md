...
9. HEC-HMS Bridge MVP：环境与 `-script` 探测、官方项目验证、文件格式校准、HydroLite 降雨写入 HEC-DSS、gage/met/control 映射、rainfall gate 和最小生成项目 `computeRun` 已验证；真实工程适配、批量 HMS 与 DSS 深度读取仍未完成。

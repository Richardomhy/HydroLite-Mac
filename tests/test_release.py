...
def test_version_imports():
    ...
    assert __release_date__ == "2026-07-17"
...
def test_version_cli_executes():
    ...
    assert "0.7.0-dev" in completed.stdout
...
def test_release_manifest_can_generate(tmp_path: Path):
    ...
    assert data["version"] == "0.7.0-dev"
    assert data["release_date"] == "2026-07-17"
...
def test_streamlit_sidebar_can_read_version():
    ...
    assert app.__version__ == "0.7.0-dev"

...
def build_gee_diagnosis() -> dict[str, Any]:
    ...
    return {
        ...
        "GOOGLE_APPLICATION_CREDENTIALS_file_exists": credentials["google_application_credentials_file_exists"],
        "streamlit_secrets_detected": credentials["streamlit_secrets_detected"],
        "local_earthengine_credentials_detected": credentials["local_earthengine_credentials_detected"],
        "gee_local_config_detected": credentials["gee_local_config_detected"],
        "gee_initialization_status": init["status"],
        "current_project": init["project"],
        "auth_source": init["auth_source"],
        "failure_reason": init["error_message"],
        "next_steps": init["next_steps"],
    }

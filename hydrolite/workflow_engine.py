...
_STAGES: tuple[WorkflowStage, ...] = (
    ...
    WorkflowStage(
        ...
        ["hec_hms_rainfall_compute.md", "hec_hms_rainfall_compute_summary.xlsx", "hec_hms_result_catalog.xlsx"],
        ...
        "generated_project_compute_verified：小型生成项目已通过 rainfall gate 并完成 computeRun；深度 DSS 读取、真实项目适配和批量 HMS 仍未完成，阶段保持 partial。",
    ),
    WorkflowStage(
        "swmm_coupling",
        "SWMM 联动",
